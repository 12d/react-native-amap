...
- (void) createMap {
//    [AMapSearchVersion sharedServices].apiKey = _apiKey;
...
- (void) insetAnnotation:(UIView*)subview
{
    if ([subview isKindOfClass:[AMapMarker class]]) {
        ...
        [_mapView addOverlay:(id<MAOverlay>)subview];
    } else if ([subview isKindOfClass:[AMapUrlTile class]]) {
        [_mapView addOverlay:(id<MAOverlay>)subview];
    }
}
...
- (void)insertReactSubview:(UIView *)subview atIndex:(NSInteger)atIndex {
    ...
    [super insertReactSubview:(UIView *)subview atIndex:(NSUInteger) atIndex];
...
- (MAOverlayRenderer *)mapView:(MAMapView *)mapView rendererForOverlay:(id <MAOverlay>)overlay{
    ...
    } else if ([overlay isKindOfClass:[AMapUrlTile class]]) {
        return ((AMapUrlTile *)overlay).renderer;
    }else{
        return nil;
    }
}
